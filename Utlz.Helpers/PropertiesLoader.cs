// from https://github.com/authlete/authlete-csharp/blob/master/Authlete/Util/PropertiesLoader.cs
...
namespace Utlz.Helpers
{
    ...
    public static class PropertiesLoader
    {
        ...
        static int? ReadFourDigitHex(string str, int start)
        {
            ...
            int? i0 = HexToInt(str[start    ]);
            int? i1 = HexToInt(str[start + 1]);
            int? i2 = HexToInt(str[start + 2]);
            int? i3 = HexToInt(str[start + 3]);
