...
namespace Utlz.Helpers
{
	internal static class TextUtils
	{
		...
		internal static string PrefixEveryLine(string prefix, string input)
		{
		...
		internal static string Indent(string input, string indentation = Indentation) =>
			PrefixEveryLine(indentation, input);
